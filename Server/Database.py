...
class DatabaseService:
    ...
    def createTables(self):
        self.cursor.execute('''CREATE TABLE IF NOT EXISTS accounts (id INTEGER PRIMARY KEY, username varchar(20), password varchar(20), email varchar(50))''')
        self.conn.commit()
